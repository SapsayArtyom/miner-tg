export const assetsBundle = [ 
    ...
    { alias:'bg_scores', src: './assets/bg_scores.png'},

    { alias:'cursor', src: './assets/cursor.png'},

    // btn
    { alias:'btn_no_hover', src: './assets/btn_no_hover.png'},
    { alias:'btn_no_on', src: './assets/btn_no_selected.png'},
    { alias:'btn_no_off', src: './assets/btn_no_idle.png'},
    { alias:'btn_yes_hover', src: './assets/btn_yes_hover.png'},
    ...
    { alias:'hit', src: './assets/sounds/SG_C_hit.wav'},
    { alias:'miss', src: './assets/sounds/SG_C_miss.wav'},
    { alias:'outofammo', src: './assets/sounds/SG_C_outofammo.wav'},
    { alias:'reload', src: './assets/sounds/SG_C_reload.wav'},
];
